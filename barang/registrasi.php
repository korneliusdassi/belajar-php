...
if(isset($_POST['register'])){
    ...
    $pass= sha1(mysqli_real_escape_string($koneksi, $_POST['pass']));
    
    $query="INSERT INTO user VALUES ('','$nama','$user','$pass')";
                ...
                <div class="card-body">
                  <form action="" method="post" role="form">
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" name="register">Sign Up</button>
                    </div>
                  </form>
                </div>
